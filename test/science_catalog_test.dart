...
void main() {
  test('science catalog has unique ids and valid ayah ranges', () {
    final catalogFile = File('assets/science/science_catalog.json');
    ...
    for (final raw in entries) {
      ...
      for (final field in ['title', 'summary', 'scienceNote']) {
